...
//
//
// class MedicalExaminationsScreen extends StatefulWidget {
//   final int step;
//   const MedicalExaminationsScreen({super.key, required this.step});
//
//   @override
//   State<MedicalExaminationsScreen> createState() => _MedicalExaminationsScreenState();
// }
//
// class _MedicalExaminationsScreenState extends State<MedicalExaminationsScreen> {
...
//     _examinationFindingsController.text = formProvider.formData['medical_examinations']?['examination_findings'] ?? '';
//     _examinationDateController.text = formProvider.formData['medical_examinations']?['examination_date'] ?? '';
//   }
//
//   @override
//   void dispose() {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Medical Examinations'),
//       ),
//       body: Column(
//         children: [
//           // Stepper(
...
//                           context: context,
//                           val: value,
//                           fieldName: 'Examination Findings',
//                           fieldType: VALIDATION_TYPE.DESCRIPTIVE_TEXT,
//                         );
//                         formProvider.setValidationError('medical_examinations', 'examination_findings', error);
//                         return error;
//                       },
//                       onChanged: (value) {
//                         formProvider.updateField('medical_examinations', 'examination_findings', value);
//                       },
//                     ),
//                     _buildTextField(
//                       context,
...
//                           context: context,
//                           val: value,
//                           fieldName: 'Examination Date',
//                           fieldType: VALIDATION_TYPE.DATE,
//                         );
//                         formProvider.setValidationError('medical_examinations', 'examination_date', error);
//                         return error;
//                       },
//                       onChanged: (value) {
//                         formProvider.updateField('medical_examinations', 'examination_date', value);
//                       },
//                     ),
//                     Row(
