...
class _SymptomsScreenState extends State<SymptomsScreen> {
  ...
  void initState() {
    ...
    _symptomsController.text = formProvider.formData['symptoms']?['symptoms'] ?? '';
    _durationController.text = formProvider.formData['symptoms']?['duration'] ?? '';
  }
                ...
                child: ListView(
                  children: [
                    _buildTextField(
                      ...
                      labelText: 'Symptoms',
                      hintText: 'Enter current symptoms',
                      icon: Icons.sick,
                      maxLines: 3,
                      validator: (value) {
                        ...
                        formProvider.setValidationError('symptoms', 'symptoms', error);
                        return error;
                      },
                      onChanged: (value) {
                        formProvider.updateField('symptoms', 'symptoms', value);
                      },
                    ),
                    _buildTextField(
                      context,
                      ...
                      labelText: 'Duration',
                      hintText: 'Enter duration of symptoms',
                      icon: Icons.timer,
                      validator: (value) {
                        final error = checkFieldValidation(
                          context: context,
                        ...
                        formProvider.setValidationError('symptoms', 'duration', error);
                        return error;
                      },
                      onChanged: (value) {
                        formProvider.updateField('symptoms', 'duration', value);
                      },
                    ),
                    Row(
